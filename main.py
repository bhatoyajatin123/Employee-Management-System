...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:1234@localhost:4306/jatin_bhatoya'
app.config['UPLOAD_FOLDER'] = "C:\\Users\\hites\\OneDrive\\Desktop\\Employee-management-system-master"
db = SQLAlchemy(app)
